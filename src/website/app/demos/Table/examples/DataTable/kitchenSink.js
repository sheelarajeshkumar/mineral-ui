...
const CustomSortableHeader = ({
  ...
  <th key={renderProps.key}>
    <button
      ...
      {state.sort &&
        state.sort.column === renderProps.name &&
...
// const columns = [
//   { content: 'Fresh Fruits', name: 'Fruits', enableSort: true, cell: CustomCell },
//   { content: 'Veritable Vegetables', name: 'Vegetables', enableSort: true, header: CustomSortableHeader },
//   { content: 'Grains', name: 'Grains', header: CustomHeader },
